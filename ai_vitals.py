...
*{box-sizing:border-box}body{margin:0;background:var(--bg);color:var(--text);font:14px ui-sans-serif,system-ui,sans-serif}main{max-width:1280px;margin:auto;padding:20px}header{display:flex;justify-content:space-between;gap:12px;align-items:center;margin-bottom:16px}h1{font-size:20px;margin:0}h1 span{color:var(--mint)}button,summary,select{cursor:pointer;font-family:inherit}.muted{color:var(--muted);font-size:12px}summary::-webkit-details-marker{display:none}details>summary{list-style:none}.btn-small,.layout-button,#shutdown{display:inline-flex;align-items:center;justify-content:center;gap:4px;height:28px;padding:0 10px;font-size:11px;font-weight:600;color:var(--text);background:var(--badge);border:1px solid var(--line);border-radius:6px;cursor:pointer;white-space:nowrap;transition:all .15s ease;text-decoration:none;box-sizing:border-box;margin:0}.btn-small:hover,.layout-button:hover{background:var(--panel);border-color:var(--mint);color:var(--mint)}#shutdown{color:#ffd7d7;background:#351923;border-color:var(--bad)}#shutdown:hover{background:#572332;border-color:var(--bad);color:#fff;box-shadow:0 2px 8px #0004}#shutdown:focus-visible{outline:2px solid #fff;outline-offset:2px}#shutdown:disabled{cursor:default;opacity:.55;transform:none}#notify-toggle.active{border-color:var(--mint);color:var(--mint)}#theme-select{display:inline-flex;align-items:center;height:28px;padding:0 8px;font-size:11px;font-weight:600;background:var(--badge);border:1px solid var(--line);color:var(--text);border-radius:6px;cursor:pointer;transition:all .15s ease;margin:0}#theme-select:hover{border-color:var(--mint)}#updated{margin:0 0 0 4px}.settings{position:absolute;right:0;z-index:2;min-width:210px;background:var(--panel);border:1px solid var(--line);border-radius:8px;padding:10px;box-shadow:0 12px 28px #0008}.settings label{display:block;padding:4px 0}.settings button{margin-top:8px}.blocks{display:grid;gap:10px}.block{border:1px solid var(--line);border-radius:12px;background:var(--panel);padding:14px}.block[hidden]{display:none}.block.dragging{opacity:.45}.block-title{display:flex;align-items:center;gap:8px;margin:0;font-size:14px}.handle{color:var(--muted);cursor:grab;user-select:none}.cards{display:grid;grid-template-columns:repeat(4,minmax(0,1fr));gap:10px}.card{border:1px solid var(--line);border-radius:10px;padding:12px;background:var(--card)}.label{color:var(--muted);font-size:12px}.value{font-size:22px;font-weight:700;margin:7px 0}.bar{height:6px;background:var(--bar-bg);border-radius:999px;overflow:hidden;margin-top:8px}.bar i{display:block;height:100%;background:var(--mint)}.plan-badge{display:inline-flex;align-items:center;gap:6px;cursor:pointer;padding:3px 8px;border-radius:6px;background:var(--badge);border:1px solid var(--line);font-size:12px;color:var(--text);transition:all .15s}.plan-badge:hover{background:var(--panel);border-color:var(--mint)}.plan-badge i{font-style:normal;font-size:11px;color:var(--mint);text-decoration:underline}.service-badge{display:inline-flex;align-items:center;gap:6px;font-size:11px;color:var(--muted);background:var(--badge);border:1px solid var(--line);border-radius:6px;padding:3px 8px}.task{padding:10px 0;border-top:1px solid var(--line)}.task:first-of-type{border-top:0}.task-head{display:grid;grid-template-columns:70px minmax(0,1fr) 155px;gap:8px;align-items:baseline}.task-head b{min-width:0}.task-index,.task-time{color:var(--muted);font-size:11px;white-space:nowrap}.task-time{text-align:right}.task b{display:block;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.task span{display:block;color:var(--muted);margin-top:3px;overflow:hidden;text-overflow:ellipsis;white-space:nowrap}.provider{display:inline-block;color:#fff!important;background:var(--mint);border-radius:999px;padding:1px 6px;font-size:10px;font-weight:600}.provider.claude{background:var(--warn);color:#1f2328!important}.provider.agy{background:var(--blue);color:#fff!important}.status-details summary{cursor:pointer;list-style:none}.status-details summary::-webkit-details-marker{display:none}details{border-top:1px solid var(--line);padding:8px 0}pre{white-space:pre-wrap;word-break:break-word;color:var(--muted);font-size:11px;margin:8px 0 0}#tasks{max-height:480px;overflow-y:auto;padding-right:4px}#tasks::-webkit-scrollbar{width:6px}#tasks::-webkit-scrollbar-track{background:transparent}#tasks::-webkit-scrollbar-thumb{background:var(--line);border-radius:3px}#tasks::-webkit-scrollbar-thumb:hover{background:var(--muted)}#history{max-height:180px;overflow-y:auto}.status-groups{display:grid;grid-template-columns:repeat(auto-fit,minmax(320px,1fr));gap:12px;margin-top:10px;border-top:1px solid var(--line);padding-top:8px}.status-group{padding:4px 0}.status-head{display:flex;justify-content:space-between;gap:8px;align-items:baseline}.status-name{font-weight:700}.status-bars{display:flex;gap:2px;margin:8px 0}.status-day{height:13px;flex:1;border-radius:1px;background:var(--mint);cursor:pointer;transition:transform .1s}.status-day:hover{transform:scaleY(1.3);opacity:.85}.status-day.warn{background:var(--warn)}.status-day.bad{background:var(--bad)}.status-group details{font-size:12px;color:var(--muted);border:0;padding:2px 0}.burn-badge{display:inline-block;font-size:10px;padding:1px 5px;border-radius:4px;font-weight:700;margin-left:5px;vertical-align:middle}.burn-badge.warn{background:#ff555522;color:var(--bad);border:1px solid var(--bad)}.burn-badge.safe{background:#50fa7b22;color:var(--mint);border:1px solid var(--mint)}.burn-badge.normal{background:#bd93f922;color:var(--blue);border:1px solid var(--blue)}.bloat-alert{display:inline-block;margin-top:6px;font-size:11px;color:var(--warn);background:#ffe60022;border:1px solid var(--warn);border-radius:4px;padding:2px 6px;line-height:1.3}@media(max-width:700px){main{padding:12px}.cards{grid-template-columns:repeat(2,1fr)}.task-head{grid-template-columns:62px minmax(0,1fr)}.task-time{grid-column:2;text-align:left}}
</style>
<main><header><div><h1><span>AI</span> VITALS</h1></div><div style="display:flex;align-items:center;gap:6px;flex-wrap:wrap"><select id="theme-select" title="カラーテーマを切り替えます"><option value="default">🎨 Default</option><option value="dracula">🧛 Dracula</option><option value="cyberpunk">⚡ Cyberpunk</option><option value="synthwave">🌆 Synthwave</option><option value="monokai">🐍 Monokai</option><option value="nord">❄️ Nord</option><option value="github-light">☀️ GitHub Light</option><option value="solarized-light">🌅 Solarized Light</option><option value="one-light">💡 One Light</option></select><button id="notify-toggle" type="button" class="btn-small" title="クォータ上限到達やリセット解除をデスクトップ通知します">🔔 通知: オフ</button><details id="layout-settings"><summary class="layout-button">⚙️ 配置と表示</summary><div class="settings"><label><input type="checkbox" data-toggle="overview"> Today's Overview</label><label><input type="checkbox" data-toggle="codex"> Codex</label><label><input type="checkbox" data-toggle="claude"> Claude</label><label><input type="checkbox" data-toggle="agy"> Antigravity</label><label><input type="checkbox" data-toggle="tasks"> Active tasks</label><label><input type="checkbox" data-toggle="history"> History</label><label>カラーテーマ<small class="muted" style="display:block;font-size:11px">※ダーク・ライト各テーマを選択</small><select id="theme-select-dialog"><option value="default">Default Dark</option><option value="dracula">🧛 Dracula</option><option value="cyberpunk">⚡ Cyberpunk 2077</option><option value="synthwave">🌆 Synthwave '84</option><option value="monokai">🐍 Monokai Pro</option><option value="nord">❄️ Nord</option><option value="github-light">☀️ GitHub Light (ライト)</option><option value="solarized-light">🌅 Solarized Light (ライト)</option><option value="one-light">💡 One Light (ライト)</option></select></label><label>Codex plan（表示用）<small class="muted" style="display:block;font-size:11px">※契約プランを選択すると画面に反映されます</small><select id="codex-plan-select"><option>未設定</option><option>ChatGPT Free</option><option>ChatGPT Go</option><option>ChatGPT Plus</option><option>ChatGPT Pro 5x</option><option>ChatGPT Pro 20x</option><option>ChatGPT Business</option><option>ChatGPT Enterprise / Edu</option><option>API 従量課金</option></select></label><label>Claude plan（表示用）<small class="muted" style="display:block;font-size:11px">※契約プランを選択すると画面に反映されます</small><select id="claude-plan-select"><option>未設定</option><option>Claude Free</option><option>Claude Pro</option><option>Claude Max 5x</option><option>Claude Max 20x</option><option>Claude Team</option><option>Claude Enterprise</option><option>API 従量課金</option></select></label><label>Antigravity plan（表示用）<small class="muted" style="display:block;font-size:11px">※契約プランを選択すると画面に反映されます</small><select id="agy-plan-select"><option>未設定</option><option>Google AI Free</option><option>Google AI Plus</option><option>Google AI Pro</option><option>Google AI Ultra 5x</option><option>Google AI Ultra 20x</option><option>API 従量課金</option></select></label><button id="layout-reset" type="button">初期配置に戻す</button></div></details><button id="shutdown" type="button">⏹ 停止</button><div id="updated" class="muted">読み込み中</div></div></header>
...
const themeKey='ai-vitals.theme';function applyTheme(theme){if(!theme||theme==='default'){document.documentElement.removeAttribute('data-theme');localStorage.removeItem(themeKey)}else{document.documentElement.setAttribute('data-theme',theme);localStorage.setItem(themeKey,theme)}const s1=$('theme-select'),s2=$('theme-select-dialog');if(s1)s1.value=theme||'default';if(s2)s2.value=theme||'default'}applyTheme(localStorage.getItem(themeKey)||'default');$('theme-select')?.addEventListener('change',e=>applyTheme(e.target.value));$('theme-select-dialog')?.addEventListener('change',e=>applyTheme(e.target.value));
